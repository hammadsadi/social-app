      ...
      <div className="flex flex-col p-6 space-y-6 overflow-hidden rounded-lg shadow-md relative  text-black/50">
          ...
          <div className="flex space-x-4">
            ...
            <div className="flex flex-col ">
              <div className="flex gap-1 items-center">
                ...
                &middot;
                <span className="text-xs">4hr</span>
              </div>
        ...
        <div>
          <img
            src={postImg}
            alt=""
            className="object-cover w-full mb-4 h-60 sm:h-96 rounded-md"
          />
        ...
        <div className="flex flex-wrap justify-between">
          <div className="space-x-2">
            ...
            >
              <svg
                ...
                viewBox="0 0 512 512"
                className="w-4 h-4 fill-current text-black/70"
              >
          ...
          <div className="flex space-x-2 text-sm text-black/50">
